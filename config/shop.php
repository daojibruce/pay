...
return array(
    ...
    'trade' => array(
        ...
        'menu' => array(
            ...
            //(电子)合同路由
            array('label'=>'调整订单详情订单信息','display'=>false,'as'=>'topshop.trade.do_adjust_order','action'=>'topshop_ctl_trade_detail@do_adjust_order','url'=>'do_adjust_order.html','method'=>'post'),
            array('label'=>'调整订单详情订单信息','display'=>false,'as'=>'topshop.trade.ajaxPayList','action'=>'topshop_ctl_trade_detail@ajaxPayList','url'=>'ajaxPayList.html','method'=>'post'),
            array('label'=>'获取订单详情订单合同金额','display'=>false,'as'=>'topshop.trade.ajaxMoneyInfo','action'=>'topshop_ctl_trade_detail@ajaxMoneyInfo','url'=>'ajaxMoneyInfo.html','method'=>'post'),
            array('label'=>'提交电子合同','display'=>false,'as'=>'topshop.trade.send_contract','action'=>'topshop_ctl_trade_detail@send_contract','url'=>'send_contract.html','method'=>'post'),
            array('label'=>'提交电子合同模板','display'=>false,'as'=>'topshop.trade.send_template','action'=>'topshop_ctl_trade_detail@send_template','url'=>'send_template.html','method'=>'post'),
            array('label'=>'发起电子合同跳转','display'=>false,'as'=>'topshop.trade.addContract','action'=>'topshop_ctl_trade_detail@addContract','url'=>'addContract.html','method'=>'get'),
            array('label'=>'发起电子合同预览','display'=>false,'as'=>'topshop.trade.previewEcontract','action'=>'topshop_ctl_trade_detail@previewEcontract','url'=>'previewEcontract.html','method'=>'get'),
    ...
    'item' => array(
        ...
        'menu' => array(
            ...
            array('label'=>'设置阶梯价格','display'=>false,'as'=>'topshop.item.stepPrice','action'=>'topshop_ctl_item@stepPrice','url'=>'item/stepPrice.html','method'=>'get'),
            array('label'=>'编辑阶梯价格','display'=>false,'as'=>'topshop.item.editStepPrice','action'=>'topshop_ctl_item@editStepPrice','url'=>'item/editStepPrice.html','method'=>'get'),
            array('label'=>'保存阶梯价格','display'=>false,'as'=>'topshop.item.saveStepPrice','action'=>'topshop_ctl_item@saveStepPrice','url'=>'item/saveStepPrice.html','method'=>'post'),
            array('label'=>'清除阶梯价格','display'=>false,'as'=>'topshop.item.deleteStepPrice','action'=>'topshop_ctl_item@deleteStepPrice','url'=>'item/deleteStepPrice.html','method'=>'get'),
