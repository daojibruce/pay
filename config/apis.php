...
return array(
    ...
    'routes' => array(
		...
		//根据会员ID获取对应的角色
        'user.get.account.roles' => ['uses' => 'sysuser_api_user_account_getRoles@getRoles', 'version' => ['v1']],
        //根据用户名/手机/邮箱 获取会员ID
         ...
         *  平台展销相关
        */
        'temai.feedback.add' => ['uses' =>'sysrate_api_addFeedback@doTemaiSave', 'version'=>['v1']],
        'temai.item.search' => ['uses' => 'sysitem_api_temaisearch_searchItems@getList', 'version'=>['v1'], 'oauth'=>true, 'level'=>70],
        'temai.item.get' => ['uses' => 'systemai_api_item_get@get', 'version'=>['v1']],
        'temai.item.create' => ['uses' => 'systemai_api_item_create@itemCreate', 'version'=>['v1']],
        'temai.item.update.dlytmpl' => ['uses' => 'systemai_api_item_updateDlytmpl@updateDlytmpl', 'version'=>['v1']],
        'image.temai.list' => ['uses' => 'image_api_temai_list@get', 'version'=>['v1']],
        'temai.dlycorp.getlist' => ['uses' => 'systemai_api_shop_getDlycorp@getList', 'version' => ['v1']],
        'temai.dlycorp.save' => ['uses' => 'systemai_api_shop_saveDlycorp@savedata', 'version' => ['v1']],
        'temai.dlycorp.remove' => ['uses' => 'systemai_api_shop_removeShopDlycorp@remove', 'version' => ['v1']],
        'image.temai.cat.add' => ['uses' => 'image_api_temai_cat_add@create', 'version'=>['v1']],
        'image.temai.cat.imagetype.list' => ['uses' => 'image_api_temai_cat_imagetypelist@get', 'version'=>['v1']],
        'image.temai.upImageName' => ['uses' => 'image_api_temai_upImageName@up', 'version'=>['v1']],
        'image.temai.cat.delete' => ['uses' => 'image_api_temai_cat_delete@delete', 'version'=>['v1']],
        'image.temai.cat.update' => ['uses' => 'image_api_temai_cat_update@edit', 'version'=>['v1']],
        'image.temai.move.cat' => ['uses' => 'image_api_temai_moveImageCat@move', 'version'=>['v1']],
        'logistics.temaitmpl.get.list' => ['uses' => 'syslogistics_api_temaitmpl_getlist@getList', 'version' => ['v1']],
        'logistics.temaitmpl.get' => ['uses' => 'syslogistics_api_temaitmpl_get@getList', 'version' => ['v1']],
        'logistics.temaitmpl.update' => ['uses' => 'syslogistics_api_temaitmpl_update@update', 'version' => ['v1']],
        'logistics.temaitmpl.add' => ['uses' => 'syslogistics_api_temaitmpl_add@create', 'version' => ['v1']],
        'logistics.temaitmpl.delete' => ['uses' => 'syslogistics_api_temaitmpl_delete@delete', 'version' => ['v1']],
        'category.tmget.cat.rel.brand' => ['uses' => 'syscategory_api_tmgetCatRelBrand@getData', 'version' => ['v1']],
        'tmimage.delete.imageLink' => ['uses' => 'tmimage_api_deleteImage@delete', 'version'=>['v1']],
        'tmitem.list.get' => ['uses' => 'systemai_api_item_list@get', 'version'=>['v1'], 'oauth'=>true, 'level'=>70],
        'temai.temai.create' => ['uses' => 'systemai_api_temai_create@itemCreate', 'version'=>['v1']],
        'temai.temai.list' => ['uses' => 'systemai_api_temai_getlist@getList', 'version'=>['v1']],
        'temai.item.delete' => ['uses' => 'sysitem_api_temai_delete@itemDelete', 'version'=>['v1']],

        'temai.search.searchItems' => ['uses' => 'systemai_api_search_searchItems@getList', 'version'=>['v1'], 'oauth'=>true],
        'temai.search.searchItems.retime' => ['uses' => 'systemai_api_search_searchItems@getRemtime', 'version'=>['v1'], 'oauth'=>true],
        'temai.trade.get.list' => ['uses' => 'systrade_api_temai_trade_list@tradeList', 'version'=>['v1']],
        'temai.search.searchItems.screen' => ['uses' => 'systemai_api_search_searchItems@getScreenStatus', 'version'=>['v1'], 'oauth'=>true],
        //结算汇总
        //'temai.clearing.detail.add' => ['uses' => 'sysclearing_api_temai_createClearingDetail@add', 'version' => ['v1']],
        'temai.clearing.getList' => ['uses' => 'sysclearing_api_temai_getSettlementList@getList', 'version' => ['v1']],
        'temai.clearing.detail.getlist' => ['uses' => 'sysclearing_api_temai_getSettlementDetailList@getList', 'version' => ['v1']],

        'temai.sysstat.data.get' => ['uses' => 'sysstat_api_temai_getStatData@getStatData', 'version' => ['v1']],
        'temai.trade.cancel.list.get' => ['uses' => 'systrade_api_temai_trade_cancel_list@get', 'version'=>['v1']],
        'temai.trade.cancel.get' => ['uses' => 'systrade_api_temai_trade_cancel_get@get', 'version'=>['v1']],

        //商家添加订单备注
        'temai.trade.add.memo' => ['uses' => 'systrade_api_temai_trade_addMemo@add', 'version'=>['v1']],

        //当线下支付时，商家有权进行确认收款和确认收货
        'temai.trade.moneyAndGoods.receipt' => ['uses' => 'systrade_api_temai_trade_moneyAndGoods@receipt', 'version' => ['v1']],
        //订单完成状态更改
        'temai.trade.confirm' => ['uses' => 'systrade_api_temai_trade_confirm@confirmTrade', 'version'=>['v1']],
        //订单价格调整
        #'trade.update.price' => ['uses' => 'systrade_api_trade_updatePrice@tradePriceUpdate', 'version'=>['v1']],
