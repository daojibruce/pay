...
return array(
    ...
    '撮合需求推送设置' => array(
        'proofing.num' => array( 'type'=>SET_T_INT,'default'=>10,'desc'=>'每次推送商家数量','vtype'=>'required&&unsignedint','helpinfo'=>'<span class=\'notice-inline\'>单位：个</span>'),
        'proofing.period' => array( 'type'=>SET_T_INT,'default'=>24, 'desc'=>'每次推送时间间隔','vtype'=>'required&&unsignedint','helpinfo'=>'<span class=\'notice-inline\'>单位：小时(h)</span>'),
    ),
    '积分设置' => array(
