...
class systemai_mdl_shop_rel_brand extends dbeav_model{
    public function getBrandIdByShopId($shopId)
    {
        $filer = array('shop_id' => $shopId);
        $brandList = $this->getList('brand_id' , $filer);
