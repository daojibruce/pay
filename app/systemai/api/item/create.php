 ...
 * item.create
 */
class systemai_api_item_create {
    ...
    {
        $return['params'] = array(
            'user_id' => ['type'=>'integer','valid'=>'required|min:1','description'=>'平台展销会员id'],
            ...
            'weight' => ['type'=>'numeric','valid'=>'numeric|min:0.001','description'=>'商品重量', 'msg'=>'重量必须为数字|重量必须大于0'],
            'length' => ['type'=>'numeric','valid'=>'numeric|min:0.001','description'=>'商品长度', 'msg'=>'长度必须为数字|长度必须大于0'],
            'width' => ['type'=>'numeric','valid'=>'numeric|min:0.001','description'=>'商品宽度', 'msg'=>'宽度必须为数字|宽度必须大于0'],
            'height' => ['type'=>'numeric','valid'=>'numeric|min:0.001','description'=>'商品高度', 'msg'=>'高度必须为数字|高度必须大于0'],
            'unit' => ['type'=>'string','valid'=>'','description'=>'计价单位'],
            'tax_rate' => ['type'=>'string','valid'=>'','description'=>'税率'],
            ...
            'spec_code' => ['type'=>'string',  'valid'=>'required', 'description'=>'商品规格号', 'msg'=>'商品规格号必填'],
            ...
            'protection_info' => ['type'=>'string','valid'=>'','description'=>'维保信息'],
    ...
    {
        $itemId = 0;
        $result = kernel::single('systemai_data_item')->add($params, $itemId);
        if($result)
        {
