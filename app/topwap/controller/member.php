...
class topwap_ctl_member extends topwap_controller{
    ...
    public function index()
    {
        ...
        $pagedata['waitsendcontract'] = app::get('topwap')->rpcCall('trade.count',array('user_id'=>$userId,'status'=>'WAIT_SENDCONTRACT'));
        $pagedata['confirmcontract'] = app::get('topwap')->rpcCall('trade.count',array('user_id'=>$userId,'status'=>'WAIT_CONFIRM'));
        $pagedata['rejectcontract'] = app::get('topwap')->rpcCall('trade.count',array('user_id'=>$userId,'status'=>'REJECT_CONTRACT'));
