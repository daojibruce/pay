...
final class syspromotion_api_hongbao_create {
    ...
    public function getParams()
    {
        $return['params'] = array(
            ...
            'user_total_money' => ['type'=>'number', 'valid'=>'required|numeric|min:0|max:1000000', 'title'=>'用户可领取总金额',  'desc'=>'用户可领取红包的总金额'],
            'user_total_num'   => ['type'=>'string', 'valid'=>'required|numeric|min:1|max:1000000', 'title'=>'用户可领取总数',    'desc'=>'用户可领取红包的总数量'],
