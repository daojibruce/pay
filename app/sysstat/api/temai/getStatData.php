<?php
class sysstat_api_temai_getStatData{
    ...
    {
        $temai_user_id = $params['temai_user_id'];
        $params['timefile'] = array('starttime'=>$params['starttime'],'endtime'=>$params['endtime']);
        $statLibTrade = kernel::single('sysstat_data_temai_shoptrade');
        if($params['timeType']=='yesterday' || $params['timeType']=='beforday')
        {
            $sysTrade = $statLibTrade->getTimeInfo($params['inforType'],$params['timeType'],$temai_user_id,$params['timefile'],$params['limit'],$params['start'],$params['orderBy']);

            $sysTradeData = $sysTrade['commonday'];
            $sysData = $statLibTrade->getTimeInfo($params['inforType'],$params['timeType'],$temai_user_id,$params['timefile']);
        ...
        {
            $sysTradeData = $statLibTrade->getTimeInfo($params['inforType'],$params['timeType'],$temai_user_id,$params['timefile'],$params['limit'],$params['start'],$params['orderBy']);
        ...
        {
            $dataInfo = $statLibTrade->getTimeInfo($params['inforType'],$params['timeType'],$temai_user_id,$params['timefile']);
            if($params['timeType'] == 'yesterday' || $params['timeType'] == 'beforday')
            {
        ...
        {
            $data = $statLibTrade->getTimeInfo($params['inforType'],$params['timeType'],$temai_user_id,$params['timefile'],$params['limit'],null,$params['orderBy']);
        ...
        {
            $count =  $statLibTrade->getTimeInfo($params['inforType'],$params['timeType'],$temai_user_id,$params['timefile']);
            $data = array(
                'sysTrade'=>$sysTrade,
