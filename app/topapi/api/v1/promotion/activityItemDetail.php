...
class topapi_api_v1_promotion_activityItemDetail implements topapi_interface_api{
    ...
    public function handle($params)
    {
        ...
        $pagedata['item'] = app::get('topapi')->rpcCall('item.get',array('item_id'=>$params['item_id'],'fields'=>'item_id,title,price,rate_count,rate_good_count,list_image,shop_id,item_count.sold_quantity,item_count.item_id,item_desc.wap_desc'));
