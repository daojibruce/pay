...
class syscategory_mdl_virtualcat extends dbeav_model
{
    ...
    public function save(&$aData, $mustUpdate = null, $mustInsert = false)
    {
        ...
        {
            $oldData = $this->getRow('virtual_cat_id, virtual_parent_id, level',array('virtual_cat_id'=>$aData['virtual_cat_id']) );
        }
    ...
    {
        $fields = 'virtual_cat_name,virtual_cat_id,virtual_parent_id,order_sort,level,virtual_cat_id,cat_path,is_leaf,child_count';
        return $this->getList($fields, array(), 0, -1, 'order_sort ASC, virtual_cat_id DESC');
    }
