...
return array (
    ...
    array (
        ...
        array (
			...
			'comment' => app::get('sysuser')->_('会员等级'),
            'order' => 40,
        ),
        'name' =>
        array (
        ...
        array (
			...
			'comment' => app::get('sysuser')->_('真实姓名'),
            'width' => 75,
            'searchtype' => 'has', // 简单搜索
        ...
        array (
			...
			'comment' => app::get('sysuser')->_('来源ID'),
            'width' => 75,
            'editable' => false,
            'filtertype' => 'normal',
            'in_list' => false,
        ...
        array (
			...
			'comment' => app::get('sysuser')->_('推广来源URL'),
            'width' => 75,
            'editable' => false,
            'filtertype' => 'normal',
            'in_list' => false,
        ...
        'email_verify' => array (
			...
			'comment' => app::get('sysuser')->_('是否通过邮箱验证'),
            'default' => 0,
        ),
        ...
        'job' =>
            array (
                ...
                'type' => 'string',
                'length' => 50,
                'label' => app::get('sysuser')->_('职位'),
				'comment' => app::get('sysuser')->_('职位'),
                'width' => 110,
                'editable' => true,
                'filtertype' => 'normal',
                'in_list' => true,
        ...
        'user_type' =>
            array (
                'type' =>
                    array (
                        0 => app::get('sysuser')->_('商城会员'),
                        1 => app::get('sysuser')->_('企业会员'),
                    ),
                'default' => 0,
                'required' => true,
                'label' => app::get('sysuser')->_('会员类别'),
                'order' => 30,
                'width' => 40,
                'editable' => true,
                'filtertype' => 'yes',
                'in_list' => true,
                'default_in_list' => true,
                'comment' => app::get('sysuser')->_('会员类别'),
            ),
        'verify_status' =>
            array (
                'type' =>
                    array (
                        0 => app::get('sysuser')->_('待审核'),
                        1 => app::get('sysuser')->_('审核通过'),
                        2 => app::get('sysuser')->_('审核不通过'),
                    ),
                'default' => 1,
                'required' => true,
                'label' => app::get('sysuser')->_('审核状态'),
                'order' => 30,
                'width' => 40,
                'editable' => true,
                'filtertype' => 'yes',
                'in_list' => true,
                'default_in_list' => true,
                'comment' => app::get('sysuser')->_('审核状态'),
            ),
        'refuse_reason' =>
            array (
                'type' => 'varchar(255)',
                'type' => 'string',
                'label' => app::get('sysuser')->_('驳回原因'),
                'width' => 110,
                'editable' => true,
                'filtertype' => 'normal',
                'in_list' => true,
        ...
        'is_master' =>
            array (
                ...
                'required' => true,
                'editable' => false,
                'comment' => app::get('sysuser')->_('是否主账号'),
            ),
        'master_user_id'=>
            array (
                'type' => 'table:account@sysuser',
                    //'pkey' => true,
                'label' => app::get('sysuser')->_('主账号id'),
                'comment' => app::get('sysuser')->_('主账号id'),
            ),
        'erp_code'=>
            array (
                'type' => 'string',
                'label' => app::get('sysuser')->_('采购员唯一编号'),
                'comment' => app::get('sysuser')->_('采购员唯一编号'),
            ),
        'cust_account_id'=>
            array (
                'type' => 'string',
                'in_list' => true,
                'default_in_list' => true,
                'label' => app::get('sysuser')->_('平安见证宝ID'),
                'comment' => app::get('sysuser')->_('平安见证宝ID'),
            ),
        'third_cust_id'=>
            array (
                'type' => 'string',
                'in_list' => true,
                'default_in_list' => true,
                'label' => app::get('sysuser')->_('平安见证宝账户名'),
                'comment' => app::get('sysuser')->_('平安见证宝账户名'),
            ),
        'referee_id'=>
            array (
                'type' => 'table:referee@sysuser',
                'in_list' => false,
                'default_in_list' => false,
                'label' => app::get('sysuser')->_('推荐来源'),
    ...
    'index' => array(
        ...
        'ind_referee_id' => ['columns' => ['referee_id']],
    ),
