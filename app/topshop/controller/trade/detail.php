...
class topshop_ctl_trade_detail extends topshop_controller{
    ...
    */
    public function progress()
    {
        ...
        return view::make('topshop/trade/progress.html',$pagedata);
    }
	...
	*/
    ...
    public function addContract(){
        ...
        $contentObj = app::get('systrade')->model('contract');
        $pagedata['contract']=$contentObj->getrow('contacts,phone,contract_img,contract_id,shop_id',array('contract_id'=>$tradeInfo['contract_id'],'shop_id'=>$tradeInfo['shop_id']));
        $contract_list = unserialize($pagedata['contract']['contract_img']);
        unset($pagedata['contract']['contract_img']);
        foreach($contract_list as $row){
            $file_name =  explode('/',urldecode($row));
    ...
    public function  previewEcontract(){
        ...
        $pagedata['company_name'] = $shopinfo['company_name'];
        $pagedata['trade']= $tradeInfo;
        return view::make('topshop/trade/econtract.html', $pagedata);
        // return $this->page('topshop/trade/econtract.html', $pagedata);
    }
    ...
    public function comment()
    {
        ...
        return $this->page('topshop/trade/comment.html', $pagedata);
    }
