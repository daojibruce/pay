...
class topshop_item_import {
    ...
    protected $shopId;
    protected $allowType = ['xls','xlsx','csv'];
    protected $allowLimit = 30;
    protected $fileTypeExtension = 'xls';
    ...
    protected function readDocument($fileInfo)
    {
        ...
        $params['type'] = $this->fileTypeExtension;
    ...
    protected function checkFile($file)
    {
        ...
        $this->fileTypeExtension = $exten;
        
        if(! in_array($exten , $this->allowType))
        {
    ...
    public function downLoadTmpl($catId)
    {
        ...
        $objWriter->downDocument($fileName, $this->fileTypeExtension);
