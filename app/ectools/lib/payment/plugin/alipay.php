...
final class ectools_payment_plugin_alipay extends ectools_payment_app implements ectools_interface_payment_app {
    ...
    public function dopay($payment)
    {
        ...
        /*
        $this->add_field('service',        'trade_create_by_buyer');
        $this->add_field('logistics_type',        'EXPRESS');
        $this->add_field('logistics_fee',        '0');
        $this->add_field('logistics_payment',        'BUYER_PAY_AFTER_RECEIVE');
         trade_create_by_buyer类型需添加这logistics配置 
         */
