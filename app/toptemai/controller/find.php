 ...
 */
class toptemai_ctl_find extends toptemai_controller {
    
    protected $_tmpltype = 'findPw_shop';

    public function index()
    {
        $this->contentHeaderTitle = app::get ('toptemai')->_ ('企业账号密码找回');
        $this->set_tmpl ('pwdfind');
        return $this->page ('toptemai/find/find_index.html');
    }
    ...
    public function firstStep()
    {
        ...
        $this->contentHeaderTitle = app::get ('toptemai')->_ ('企业账号密码找回');
        $this->set_tmpl ('pwdfind');
        return $this->page ('toptemai/find/find_one.html', array (
                'type' => $type 
        ));
    }
    // 找回密码第二步
    public function secondStep()
    {
        ...
        {
            return redirect::action ('toptemai_ctl_find@index');
        }
        ...
        return $this->page ('toptemai/find/find_two.html', $data);
    }
    ...
    public function resetPassword()
    {
        ...
        try
        {
            ...
            {throw new \LogicException (app::get ('toptemai')->_ ($msg));}
            // 获取商家账户序号ID
            $type = $request ['type'];
            $filter = array ();
    ...
    public function checkFindInfo()
    {
        ...
        try
        {
            ...
            switch ($type)
            {
                case 'mobile' :
                    ...
                    {throw new \LogicException (app::get ('toptemai')->_ ('手机号码未认证，请换一个重试'));}
                    // 验证手机和验证码
                    if (! userVcode::verify ($request ['find_code'], $mobile, $this->_tmpltype))
                    {throw new \LogicException (app::get ('toptemai')->_ ('验证码错误，请重新填写'));}
                ...
                case 'email' :
                    ...
                    {throw new \LogicException (app::get ('toptemai')->_ ('邮箱未认证，请换一个重试'));}
                    // 验证邮箱和验证码
        ...
        $url = url::action ('toptemai_ctl_find@secondStep');
    ...
    private function __checkImageCode($request)
    {
        ...
        {
            throw new \LogicException (app::get ('toptemai')->_ ('图片验证码错误!'));
        }
