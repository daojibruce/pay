 ...
 */
class toptemai_ctl_auth_index extends toptemai_controller {
    ...
    public function index()
    {
        ...
        return $this->page ('toptemai/auth/safe.html', $sellData);
    }
    ...
    public function checkPassword()
    {
        ...
        return $this->page ('toptemai/auth/pwd.html', $pagedata);
    }
    ...
    public function doCheckPassword()
    {
        ...
        {
            $url = url::action('toptemai_ctl_auth_code@updateAuth', array (
                    'type' => $data['type']
            ));
        }else
        {
            $url = url::action('toptemai_ctl_auth_index@auth', array (
                    'type' => $data['type']
            ));
        }
    ...
    public function auth()
    {
        ...
        return $this->page('toptemai/auth/authinfo.html', $pagedata);
    }
    /**
     * 处理手机号和邮箱
     * @param string $mobile
