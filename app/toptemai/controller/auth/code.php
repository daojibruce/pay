 ...
 */
class toptemai_ctl_auth_code extends toptemai_controller {
        ...
        try {
            ...
            switch ($type) {
                case 'mobile' :
                    ...
                    if($bool)
                    {
                        throw new \LogicException (app::get ('toptemai')->_ ('手机号已存在，请换一个重试'));
                    }
                ...
                case 'email' :
                    ...
                    if($bool)
                    {
                        throw new \LogicException (app::get ('toptemai')->_ ('邮箱地址已存在，请换一个重试'));
                    }
    ...
    public function checkAuth($isAuth = TRUE)
    {
        ...
        try {
            ...
            app::get('toptemai')->rpcCall('auth.shop.updata',$data);
        ...
        $url = url::action('toptemai_ctl_auth_index@index');
    ...
    public function updateAuth()
    {
        ...
        {return redirect::action ('toptemai_ctl_auth_index@index');}
        ...
        $this->contentHeaderTitle = app::get ('toptemai')->_ ('安全中心');
        $request = input::get();
        return $this->page('toptemai/auth/updateauth.html', $request);
    }
