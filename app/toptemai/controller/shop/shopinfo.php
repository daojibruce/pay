...
class toptemai_ctl_shop_shopinfo extends toptemai_controller
{
	public function index()
	{
        ...
        {
            $pagedata['shopCatInfo'] = app::get('toptemai')->rpcCall('shop.get.cat.fee',array('shop_id'=>$shopId));
        }

		return $this->page('toptemai/shop/shopapplyinfo.html', $pagedata);
	}
}
