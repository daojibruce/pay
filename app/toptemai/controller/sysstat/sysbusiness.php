...
class toptemai_ctl_sysstat_sysbusiness extends toptemai_controller
{
	public function index()
	{
		...
		$pagedata['pagers'] = array(
			'link'=>url::action('toptemai_ctl_sysstat_sysbusiness@index',$postSend),
			'current'=>$current,
			'total'=>$total,
		...
		$this->contentHeaderTitle = app::get('toptemai')->_('运营报表-业务数据分析');
		return $this->page('toptemai/sysstat/sysbusiness.html', $pagedata);
	}
