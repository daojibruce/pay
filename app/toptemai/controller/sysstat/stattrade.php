...
class toptemai_ctl_sysstat_stattrade extends toptemai_controller
{
	public function index()
	{
		...
		$pagedata['pagers'] = array(
			'link'=>url::action('toptemai_ctl_sysstat_stattrade@index',$postSend),
			'current'=>$current,
			'total'=>$total,
		...
		$this->contentHeaderTitle = app::get('toptemai')->_('运营报表-交易数据分析');
		return $this->page('toptemai/sysstat/stattrade.html', $pagedata);
	}
