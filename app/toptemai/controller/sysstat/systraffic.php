...
class toptemai_ctl_sysstat_systraffic extends toptemai_controller
{
    /**
     * 根据时间shopid获取商家运营情况
     * @param null
    ...
    public function index()
    {
        ...
        $data = app::get('toptemai')->rpcCall('sysstat.traffic.data.get',$notAll);
        ...
        $pagedata['pagers'] = array(
            'link'=>url::action('toptemai_ctl_sysstat_systraffic@index',$postSend),
            'current'=>$current,
            'total'=>$total,
            'use_app' => 'toptemai',
        ...
        $this->contentHeaderTitle = app::get('toptemai')->_('运营报表-流量数据分析');
        return $this->page('toptemai/sysstat/systraffic.html', $pagedata);
    }
    ...
    public function ajaxTrade()
    {
        ...
        $datas =  app::get('toptemai')->rpcCall('sysstat.traffic.data.get',$all,'seller');
