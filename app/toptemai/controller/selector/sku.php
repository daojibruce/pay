<?php
class toptemai_ctl_selector_sku extends toptemai_controller {
	public $limit = 18;
	...
	public function loadSelectSkuModal()
    {
        ...
        $pagedata['shopCatList'] = app::get('toptemai')->rpcCall('shop.authorize.cat',array('shop_id'=>$this->shopId));
        return view::make('toptemai/selector/sku/index.html', $pagedata);
    }
    ...
    public function formatSelectedSkusRow()
    {
        ...
        return view::make('toptemai/selector/sku/input-row.html', $pagedata);
    }
    ...
    public function searchSku($json=true)
    {
        ...
        if(trim($brandName) && trim($brandName) != 'undefined')
        {
            ...
            {
                return view::make('toptemai/selector/sku/list.html', $pagedata);
            }
        }
        ...
        $filter['pages'] = time();
        $pagers = array(
            'link' => url::action('toptemai_ctl_selector_sku@searchSku', $filter),
            'current' => $pages,
            'use_app' => 'toptemai',
            'total' => $totalPage,
            'token' => time(),
