...
class toptemai_ctl_register extends toptemai_controller {
    ...
    {
        $pagedata=[];
        return $this->page('toptemai/register/signCheckPhonePage.html', $pagedata);
    }
    ...
    public function signCheckPhoneAction()
    {
        ...
        $url = url::action('toptemai_ctl_register@signPage');
    ...
    public function signPage()
    {
        ...
        if(!$mobile)
            return redirect::action('toptemai_ctl_register@signCheckPhonePage');
        ...
        return $this->page('toptemai/register/signPage.html', $pagedata);
    }
  ...
  //}
    ...
    public function enterAgreementPage()
    {
        ...
        return $this->page('toptemai/register/enterAgreementPage.html', $pagedata);
    }
    ...
    public function enterProcessCompanyInfo()
    {
        ...
        $pagedata['resUrl'] = app::get('toptemai')->res_url;
        $pagedata['loginFlag'] = pamAccount::getAccountId() ?  true : false;
        return $this->page('toptemai/register/enterProcessCompanyInfo.html', $pagedata);
    }
    ...
    public function enterProcessCompanyInfoAction()
    {
        ...
        $validator = validator::make ([
            ...
            'shop_info.corporate_identity_img_z' => app::get('toptemai')->_('请上传身份证正面照片'),
            'shop_info.corporate_identity_img_f' => app::get('toptemai')->_('请上传身份证反面照片'),
            'shop_info.license_img' => app::get('toptemai')->_('请上传营业执照照片'),
            'shop_info.tissue_code_img' => app::get('toptemai')->_('请上传组织机构代码照片'),
            ]);
        try{
            $validator->newFails ();
        }catch(Exception $e) {
        ...
        $url = url::action('toptemai_ctl_register@enterProcessEconomicInfo');
        return $this->splash('success',$url,$msg,true);
    }
    ...
    public function enterProcessEconomicInfo()
    {
        ...
        $pagedata['resUrl'] = app::get('toptemai')->res_url;
        $pagedata['loginFlag'] = pamAccount::getAccountId() ?  true : false;
        return $this->page('toptemai/register/enterProcessEconomicInfo.html', $pagedata);
    }
    ...
    public function enterProcessEconomicInfoAction()
    {
        ...
        $validator = validator::make ([
            ...
            'shop_info.tax_code_img' => app::get('toptemai')->_('请上传税务登记证照片'),
            ]);
        try{
            $validator->newFails ();
        }catch(Exception $e) {
        ...
        if($economicInfo['action'] == 'back')
            $url = url::action('toptemai_ctl_register@enterProcessCompanyInfo');
        else
            $url = url::action('toptemai_ctl_register@enterProcessShopInfo');
        return $this->splash('success',$url,$msg,true);
    }
    ...
    public function enterProcessShopInfo()
    {
      ...
      $lv1Catlists = app::get('toptemai')->rpcCall('category.cat.get.info',array('fields'=>'cat_id,cat_name','parent_id'=>0,'level'=>1));
        ...
        $shopTypelist = app::get('toptemai')->rpcCall('shop.type.get');
        $pagedata['shoptypelist'] = $shopTypelist;
        $pagedata['loginFlag'] = pamAccount::getAccountId() ?  true : false;

        return $this->page('toptemai/register/enterProcessShopInfo.html', $pagedata);
    }
    ...
    public function enterProcessShopInfoAction()
    {
        ...
        $verro = [
            'shop_info.shopuser_identity_img_z' => app::get('toptemai')->_('请上传身份证正面照片'),
            'shop_info.shopuser_identity_img_f' => app::get('toptemai')->_('请上传身份证反面照片'),
            ];
        if(in_array($shopInfo['shop_type'], ['flag', 'brand', 'self']))
        {
            ...
            $verro['shop_info.brand_warranty'] = app::get('toptemai')->_('请上传品牌授权书电子版');
        }
        ...
        try{
            ...
            if($shopInfo['shop_type'] == 'self')
                throw new LogicException(app::get('toptemai')->_('店铺类型错误'));
        ...
        else
        {
            ...
            try{
                ...
                $result = app::get('toptemai')->rpcCall('shop.create.enterapply',$post);
                $msg = app::get('toptemai')->_('申请入驻成功');
                $url = url::action('toptemai_ctl_register@enterProcessWaiteExamine');
                $this->__cleanStore();
                return $this->splash('success',$url,$msg,true);
    ...
    {
        $datalist = app::get('toptemai')->rpcCall('shop.get.enterapply',array('seller_id'=>$this->sellerId,'fields'=>'*'));
        ...
        return redirect::action('toptemai_ctl_register@enterProcessCompanyInfo');
    }
    ...
    public function enterProcessWaiteExamine()
    {
      ...
      //$datalist = app::get('toptemai')->rpcCall('shop.get.enterapply',array('seller_id'=>$sellerId,'fields'=>'enterlog'));
      //$datalist['enterlog'] = unserialize($datalist['enterlog']);
      //$pagedata['logdata']=$datalist['enterlog'];
        $pagedata['loginFlag'] = pamAccount::getAccountId() ?  true : false;
        return $this->page('toptemai/register/enterProcessWaiteExamine.html', $pagedata);
    }
    ...
    {
        $sellerId = pamAccount::getAccountId();
        $datalist = app::get('toptemai')->rpcCall('shop.get.enterapply',array('seller_id'=>$sellerId,'fields'=>'enterlog,status'));
        $datalist['enterlog'] = unserialize($datalist['enterlog']);
        $pagedata['logdata']=$datalist['enterlog'];
        $pagedata['data'] = $datalist;
        $pagedata['loginFlag'] = pamAccount::getAccountId() ?  true : false;
        return $this->page('toptemai/register/enterProcessWaiteAward.html', $pagedata);
    }
    ...
    private function __checkpost(&$postdata)
    {
        ...
        {
            $msg = app::get('toptemai')->_("营业期限不能大于2286-01-01");
        ...
        {
            $msg = app::get('toptemai')->_("店铺类型不能为空");
            throw new \LogicException($msg);
        }

        if(!array_filter($postdata['shop']['shop_cat']))
        {
            $msg = app::get('toptemai')->_("类目不能为空");
            throw new \LogicException($msg);
        }
        ...
        if($postdata['shop_name'])
        {
            ...
            try{
                app::get('toptemai')->rpcCall('shop.name.check',$params);
            }
            catch(LogicException $e)
            {
        ...
        if($postdata['shop_info']['is_mainland'] == self::NO_MAINLAND)
        {
            ...
            {
                $msg = app::get('toptemai')->_("请填写护照号码");
                throw new \LogicException($msg);
            }
        }
        ...
        app::get('toptemai')->rpcCall('shop.check.brand.sign',$postdata);
    ...
    private function __checkPostImg($shopInfo,$shopType)
    {
        ...
        // 设置必上传的图片数组
        $imgInfo = [
                'corporate_identity_img_z' => app::get('toptemai')->_("请上传法人身份证正面复印件"),
                'corporate_identity_img_f' => app::get('toptemai')->_("请上传法人身份证反面复印件"),
                'license_img' => app::get('toptemai')->_("请上传营业执照副本复印件"),
                'tissue_code_img' => app::get('toptemai')->_("请上传组织机构代码证复印件"),
                'tax_code_img' => app::get('toptemai')->_("请上传税务登记证复印件"),
                'brand_warranty' => app::get('toptemai')->_("请上传品牌授权书电子版"),
                'shopuser_identity_img_z' => app::get('toptemai')->_("请上传店主身份证电子版正面"),
                'shopuser_identity_img_f' => app::get('toptemai')->_("请上传店主身份证电子版反面")
        ];
