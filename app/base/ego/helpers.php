...
class base_static_utils
{
	...
	static public function _format_input($column, $input)
	{
		if (!is_array($input)) {
			return $input;
		}
	...
	static public function _format_page($total, $pageNo = 1, $pageSize = 10)
	{
...
function ecos_d6d1fba73ce7ce09119ab0417cfadf34492bc6da()
{
	return true;
}
