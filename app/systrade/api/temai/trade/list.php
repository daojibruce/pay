<?php
class systrade_api_temai_trade_list{
    public $apiDescription = "获取订单列表";
    public function getParams()
    {
        $return['params'] = array(
            'user_id' => ['type'=>'int', 'valid'=>'', 'default'=>'', 'example'=>'','description'=>'订单所属用户id'],
            'temai_user_id' => ['type'=>'int', 'valid'=>'int', 'default'=>'', 'example'=>'','description'=>'订单所属平台展销会员id'],
            ...
            'order_type' => ['type'=>'string', 'valid'=>'', 'default'=>'', 'example'=>'','description'=>'是否是服务撮合订单'],
    ...
    public function tradeList($params)
    {
        ...
        if($orderRow && $tradeLists)
        {
            ...
            if($params['is_aftersale'])
            {
                ...
                $afterParams['temai_user_id'] = $params['temai_user_id'];
