...
class systrade_api_temai_trade_cancel_get {
    ...
    public function getParams()
    {
        $return['params'] = array(
            ...
            'temai_user_id' => ['type'=>'int','valid'=>'', 'description'=>'平台展销会员ID'],
    ...
    public function get($params)
    {
        ...
        if( $params['temai_user_id'] && $tradecancelRow['temai_user_id'] !=  $params['temai_user_id'] )
        {
            throw new \Exception("参数错误");//当前用户和取消记录中存储的用户ID不一致
        }
