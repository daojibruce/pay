<?php
class systrade_api_temai_trade_moneyAndGoods{
    ...
    {
        //获取被操作的订单信息
        $params['fields'] = "user_id,tid,temai_user_id,status,payment,post_fee,pay_type,receiver_state,receiver_city,receiver_district,receiver_address,receiver_name,receiver_mobile,orders.tid,orders.oid,orders.item_id,orders.sku_id,orders.num,orders.sub_stock";
        ...
        try{
            ...
            $result = app::get('systrade')->rpcCall('temai.trade.confirm',$finishParam,'buyer');
        }
        catch( \Exception $e )
        {
            throw $e;
