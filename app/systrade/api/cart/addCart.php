...
class systrade_api_cart_addCart{
    ...
    public function getParams()
    {
        $return['params'] = array(
            ...
            'is_temai' => ['type'=>'int','valid'=>'','description'=>'','default'=>'','example'=>'0'],
        );
        return $return;
    }
    public function addCart($params)
    {
        ...
        $is_spec = isset($params['is_temai']) ? (int)$params['is_temai'] : 0;
        $data = kernel::single('systrade_data_cart', $user_id)->addCart($params, $is_spec);
        return $data;
    }
}
