...
return  array(
    'columns'=>array(
        ...
        'aftersales_status' => array(
            'type' => array(
                'WAIT_SENDTRACT' => '买家已经申请退款，等待卖家同意',
                'WAIT_CONFIRM' => '买家已经申请退款，等待卖家同意',
        ...
        'isdel_trade_shop' => array(
            'type' => 'bool',
            'required' => true,
            'default' => 0,//0:未删;1:已删
            'comment' => app::get('systrade')->_('是否在交易过的商家列表删除'),
        ),
        //custom s zcy 与erp数据对照所用
        'issend' => array(
            'type' => 'bool',
            'default' => 0,
        ...
        'progress' => array(
            'type' => 'string',
            'comment' => app::get('systrade')->_('生产进度'),
            'label' => app::get('systrade')->_('生产进度'),
        ),
    ),
    'primary' => 'oid',
    'index' => array(
