...
$setting = array(
    ...
    'temai.limit_apply' => array('type'=>SET_T_INT, 'desc'=>app::get('site')->_('当天可推平台展销商品数限制'), 'default'=>''),
    'temai.usage_agreement' => array('type'=>SET_T_HTML, 'desc'=>app::get('site')->_('平台展销商入驻协议'), 'default'=>''),
