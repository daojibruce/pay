...
class site_theme_tmpl
{
    ...
    private function __get_tmpl_list($platform) {
        ...
        $ctl['pc'] = array(
            ...
            'ecloud'=>app::get('site')->_('企业云页'),
            'proofing'=>app::get('site')->_('服务撮合中心页'),
            'proofing_more'=>app::get('site')->_('服务商列表页'),
            'proofing_passport'=>app::get('site')->_('服务商注册页'),
            'proofing_release'=>app::get('site')->_('发布撮合需求页'),
            'temai'=>app::get('site')->_('平台展销首页'),
            'obor'=>app::get('site')->_('一带一路页'),
            'witness'=>app::get('site')->_('金融中心页'),
            'logistics'=>app::get('site')->_('物流中心页'),
            'platforms'=>app::get('site')->_('平台展销页'),
            'matchmaking'=>app::get('site')->_('服务撮合页'),
            'brands'=>app::get('site')->_('品牌页'),
