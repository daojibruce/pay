...
return  array(
    'columns'=> array(
        ...
        'length' => array(
            ...
            'required' => true,
            'default' => 0,
            'label' => app::get('sysitem')->_('商品长'),
            'comment' => app::get('sysitem')->_('商品长'),
            'in_list' => true,
            'default_in_list' => false,
        ),
        'width' => array(
            ...
            'required' => true,
            'default' => 0,
            'label' => app::get('sysitem')->_('商品宽'),
            'comment' => app::get('sysitem')->_('商品宽'),
            'in_list' => true,
            'default_in_list' => false,
        ),
        'height' => array(
            ...
            'required' => true,
            'default' => 0,
            'label' => app::get('sysitem')->_('商品高'),
            'comment' => app::get('sysitem')->_('商品高'),
            'in_list' => true,
            'default_in_list' => false,
        ),
        'unit' => array(
        ...
        'tax_rate' => array(
            ...
            'required' => true,
            'default' => '未税',
            'label' => app::get('sysitem')->_('商品税率'),
            'comment' => app::get('sysitem')->_('商品税率'),
            'filtertype' => 'normal',
            'filterdefault' => true,
            'in_list' => true,
            'default_in_list' => false,
       ...
       // ),
        ...
        'step_price' => array(
            'type' => 'serialize',
            'label' => app::get('sysitem')->_('阶梯价格,序列化'),
        ),
        'protection_info' => array(
            'type' => 'text',
            'comment' => app::get('sysitem')->_('维保信息'),
            'filtertype' => 'normal',
        ),
        'order_weight' =>array(
            'type' => 'number',
