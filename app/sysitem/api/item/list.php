...
class sysitem_api_item_list {
    ...
    public function getParams()
    {
        $return['params'] = array(
            ...
            'item_disabled' => ['type'=>'string','valid'=>'','description'=>'商品状态','example'=>'0'],
        ...
        $return['extendsFields'] = ['item_store','sub_title','bn','item_status','sku', 'sku_id'];
